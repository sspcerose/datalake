    ...
    public function getProgress()
{
    ...
    //     $batchSize = 5000; // 5000 rows at a time
    //     $rows = [];
    //     $totalRows = 0;
    ...
    //     $processedRows = 0;
    //     Cache::put('import_progress', 0, 600);
    ...
    //         $formattedTimestamp = isset($row[1]) ? Carbon::parse($row[1])->format('Y-m-d H:i:s') : null;
    ...
    //             Cache::put('import_progress', $progress, 600);
    //         }
    //     }
    ...
    //         $this->insertBatch($rows);
    //         $processedRows += count($rows);
    //         Cache::put('import_progress', 100, 600);
    //     }
    ...
    $table = 'users'; // Replace with your target table
    $columns = [
        'username' => 'username',
        ...
        'password' => 'password',
        'status' => 'status',
    ]; // Map database columns to Excel headings
...
$table = 'histories'; // Replace with your target table
$columns = [
...
public function processBatch(Request $request)
{
    ...
    if (!empty($insertData)) {
        History::insert($insertData); // Bulk insert for better performance
    }
...
// WEATHER
    public function weatherProcess(Request $request){
        ...
        // Create a temporary storage directory for chunks
