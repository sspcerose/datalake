      ...
      <div class="card-body">
        ...
        <div class="row mb-6">
          ...
          <div class="row justify-content-end">
            <div class="col-sm-10">
              <div class="mt-6">
                <button type="submit" class="btn btn-warning me-3" id="confirmUpdateButton">Save changes</button>
              </div>
            </div>
          </div>
        </form>
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('password.update') }}" id="changePassForm">
          @csrf
          <div class="row mb-6 form-password-toggle mt-6">
              <label class="col-sm-2 col-form-label"  for="password">Current Password</label>
              <div class="col-sm-10">
              <div class="input-group input-group-merge">
