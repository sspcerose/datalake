        ...
        <form action="{{ route('dashboard-analytics') }}" method="GET" class="d-flex align-items-center me-3">
            <select name="filter" id="filterDropdown" class="p-2 border rounded w-75 me-2" onchange="this.form.submit()">
                    <option value="">Filter</option>
                        ...
                        <option value="MGMT" {{ request('filter') == 'MGMT' ? 'selected' : '' }}>MGMT</option>
                        <option value="Coldplay" {{ request('filter') == 'Coldplay' ? 'selected' : '' }}>Cold Play</option>
                        <option value="Lana Del Rey" {{ request('filter') == 'Lana Del Rey' ? 'selected' : '' }}>Lana Del Rey</option>
                        <option value="John Mayer" {{ request('filter') == 'John Mayer' ? 'selected' : '' }}>John Mayer</option>
